...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 3342028521949503483),
      name: 'Group',
      lastPropertyId: const IdUid(3, 5347199657313867984),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 5271762049760332101),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 1656406119828785754),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 5347199657313867984),
            name: 'color',
            type: 6,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 3013448777929879633),
      name: 'Task',
      lastPropertyId: const IdUid(4, 7445044116806118916),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6091793777681445129),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 461094796640530890),
            name: 'descripcion',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 1490955041284183879),
            name: 'completed',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 7445044116806118916),
            name: 'groupId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 5900543127481136720),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 3013448777929879633),
      lastIndexId: const IdUid(1, 5900543127481136720),
